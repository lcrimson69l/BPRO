...
public class PencarianData{
 ...
 public static void hapusnim(String[]nim, int h)
  {
  System.out.println(h);
  for (int a=h;a<(nim.length-1);a++)
   {     
     nimx[a]=nimx[a+1];
   }
  for (int a=h;a<(daftarNama.length-1);a++)
   {
     daftarNama[a]=daftarNama[a+1];
   }
  }
 ...
 System.out.println("4. Hapus");
      ...
      switch(pilihan){
        ...
        case 3:
          ...
          break;
 case 4:
  System.out.print("Masukkan indek yang akan dihapus : ");
